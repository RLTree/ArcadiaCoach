...
INSTRUCTIONS = (
    ...
    "If the brief lists requirements, compare each minimum rating to the learner's current snapshot, surface unmet thresholds explicitly, and coach the learner on how to raise those ratings before launching. "
